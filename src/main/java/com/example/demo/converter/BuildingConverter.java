...
//			DistrictEntity districtEntity = districtRepository.findNameById(result1.getDistrictid().getId()); 
			buildingRespone.setAddress(result1.getStreet() + " "+ result1.getWard()+" "+ result1.getDistrictid().getName());
